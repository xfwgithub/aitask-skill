...
```bash
# 下载最新版本
curl -L -o /tmp/task-skill-v0.3.0.zip https://github.com/xfwgithub/aitask-skill/releases/download/v0.3.0/task-skill-v0.3.0.zip

# 解压
unzip /tmp/task-skill-v0.3.0.zip -d /tmp/

# 移动到技能目录
mkdir -p ~/.agents/skills
mv /tmp/task-skill-v0.3.0 ~/.agents/skills/task-management

# 清理
rm /tmp/task-skill-v0.3.0.zip
```
